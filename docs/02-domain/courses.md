...
> Source: ASK Training Calendar 2026 PDFs. Compiled June 2026. Uses company internal terminology.
...
- A **module** that is part of a structured **programme** (ACDM, DDM, SDDM, CIIO, ACIIO, DIIO)
...
|---|---|---|
| `ACDM` | Advanced Certificate in Digital Marketing | 5 modules |
| `DDM` | Diploma in Digital Marketing | 6 modules + 1 Capstone |
| `SDDM` | Specialist Diploma in Digital Marketing | 7 modules + 1 Capstone |
| `CIIO` | Certificate in Infocomm Technology - Infrastructure & Operations | 7 modules (M1-M7) |
| `ACIIO` | Advanced Certificate in IT Infrastructure and Operations | 6 modules + 1 Capstone (AM1-AM7) |
| `DIIO` | Diploma in Infocomm Technology - Infrastructure and Operations | 7 modules + 1 Capstone (DM1-DM8) |
...
- `ACDM-DMA` = Digital Marketing Analytics module of ACDM
- `DDM-DCC` = Digital Content Creation module of DDM
- `CIIO-M1` = Module 1 of CIIO
- `ACIIO-AM7` = Capstone of ACIIO
- `DIIO-DM8` = Capstone of DIIO
...
### ACDM — Advanced Certificate in Digital Marketing
...
### SDDM — Specialist Diploma in Digital Marketing
...
### CIIO — Certificate in Infocomm Technology Infrastructure & Operations
...
### ACIIO — Advanced Certificate in IT Infrastructure and Operations
...
### DIIO — Diploma in Infocomm Technology Infrastructure & Operations
...
```
code            — primary key (e.g. ACDM-DMA, ASKMEI, CIIO-M5)
name            — full display name
programme_code  — ACDM/DDM/SDDM/CIIO/ACIIO/DIIO/ASK or blank for standalone
...
- Total entries: 142
- Programmes: 7 (incl. ASK)
- Capstones: 4
- Recently added (NEW! in PDF): 19
